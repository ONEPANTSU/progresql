...
import DatabasePanel from '@/features/database-browser/DatabasePanel';
import ERDiagram from '@/features/er-diagram/ERDiagram';
import SQLEditor, { SQLEditorHandle } from '@/features/sql-editor/SQLEditor';
import QueryResults from '@/features/query-results/QueryResults';
import ChatPanel, { ChatPanelHandle } from '@/features/agent-chat/ChatPanel';
import SettingsPanel from '@/features/settings/SettingsPanel';
import EditConnectionDialog from '@/features/database-browser/EditConnectionDialog';
...
import { DatabaseServer, DatabaseStructureResponse, Field, QueryResult } from '@/shared/types';
import { useAuth } from '@/features/auth/AuthProvider';
import { useRouter } from 'next/router';
import { loadConnections, saveConnections, debugLocalStorage } from '@/entities/database/connectionStorage';
...
import { useSQLTabs } from '@/features/sql-editor/useSQLTabs';
