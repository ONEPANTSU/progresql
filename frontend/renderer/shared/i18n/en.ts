const en = {
  ...
  'chat.context.tooltip': 'Chat context',
  'chat.context.title': 'Context for this chat',
  'chat.context.pagesSynced': '{count} pages synced',
  'chat.context.notSynced': 'Not synced',
  'chat.trace.title': 'Agent steps',
  'chat.trace.hide': 'Hide agent steps',
  'chat.trace.show': 'Show agent steps',
  'chat.trace.running': 'Running',
  'chat.trace.completed': 'Done',
  'chat.trace.failed': 'Failed',
  ...
  'schemaSync.tables': 'Tables',
  'schemaSync.enums': 'Enums',
  'schemaSync.views': 'Views',
  'schemaSync.routines': 'Routines',
  'schemaSync.sequences': 'Sequences',
  'schemaSync.triggers': 'Triggers',
  'schemaSync.domains': 'Domains',
  'schemaSync.rename': 'RENAME',
  'schemaSync.restoreRename': 'Restore rename',
  'schemaSync.splitAddDrop': 'Split into ADD + DROP',
  'schemaSync.replacement': 'Replacement',
  'schemaSync.nullReplacement': 'NULL (fail on NOT NULL columns)',
  'schemaSync.skipDataMigration': "Skip data migration \u2014 emit raw cast (fails if rows still hold '{value}')",
  'schemaSync.splitRenameHint': "Will emit `ADD VALUE '{to}'` and `DROP VALUE '{from}'` as separate ops. Drop-value needs a replacement label below.",
  'schemaSync.unknownError': 'Unknown error',
  'schemaSync.destructiveOps': '{count} destructive',
  'schemaSync.opsCount': '{count} ops',
  'schemaSync.opCountSingular': '{count} op',
  'schemaSync.colsDepend': '{count} col depend',
  'schemaSync.colsDependPlural': '{count} cols depend',
  ...
  'schemaSync.enumValueChanges': 'Value changes',
  'schemaSync.renameValueTooltip': 'Rename value (ALTER TYPE ... RENAME VALUE)',
  'schemaSync.splitValueTooltip': 'Split into ADD + DROP (requires data migration)',
  'schemaSync.destructiveTooltip': 'Destructive operation — review carefully',
  ...
  'knowledge.addConfluenceSource': 'Add Confluence source',
  'knowledge.noSources': 'No sources yet',
  'knowledge.noSourcesHint': 'Add Confluence docs scoped to this database.',
  'knowledge.emptyPrompt': 'Add a source to configure documentation for this database connection.',
  'knowledge.section.source': 'Source',
  'knowledge.section.connection': 'Confluence connection',
  'knowledge.section.scope': 'Scope',
  'knowledge.section.chatUsage': 'Chat usage',
  'knowledge.section.indexing': 'Indexing',
  'knowledge.type': 'Type',
  'knowledge.type.confluence': 'Confluence',
  'knowledge.type.notionComingSoon': 'Notion - coming soon',
  'knowledge.type.gitComingSoon': 'Git / Markdown - coming soon',
  'knowledge.type.dbtComingSoon': 'dbt docs - coming soon',
  'knowledge.type.openMetadataComingSoon': 'OpenMetadata - coming soon',
  'knowledge.name': 'Name',
  'knowledge.database': 'Database',
  'knowledge.allDatabases': 'All databases',
  'knowledge.enabledForScope': 'Enabled for this scope',
  'knowledge.baseUrl': 'Base URL',
  'knowledge.edition': 'Confluence edition',
  'knowledge.edition.cloud': 'Cloud',
  'knowledge.edition.dataCenter': 'Data Center / Server',
  'knowledge.editionHint': 'Cloud uses /wiki/rest/api; Data Center uses /rest/api.',
  'knowledge.auth': 'Authentication',
  'knowledge.auth.apiToken': 'API token',
  'knowledge.auth.pat': 'PAT',
  'knowledge.authHint': 'Cloud API tokens require email; PAT is for server-style tokens.',
  'knowledge.email': 'Email',
  'knowledge.token': 'Token',
  'knowledge.scope.spaces': 'Specific spaces',
  'knowledge.scope.pageTree': 'Page tree',
  'knowledge.scope.cql': 'CQL filter',
  'knowledge.scope.manualComingSoon': 'Manual pages - coming soon',
  'knowledge.scope.spaceKeys': 'Space keys',
  'knowledge.scope.rootPage': 'Root page URL or ID',
  ...
  'knowledge.autoSync': 'Enable auto-sync',
  'knowledge.autoSyncHint': 'Runs only while the desktop app is open. Manual sync is still available.',
  'knowledge.autoSyncInterval': 'Interval, minutes',
  ...
  'knowledge.save': 'Save',
  'knowledge.close': 'Close knowledge sources',
  'knowledge.status.connectionSuccessful': 'Connection successful.',
  'knowledge.status.connectionFailed': 'Connection failed.',
  'knowledge.status.syncing': 'Syncing matched pages...',
  'knowledge.status.syncFailed': 'Sync failed.',
  'knowledge.status.synced': 'Synced {pages} page(s), {chunks} chunk(s).',
  'knowledge.status.previewing': 'Previewing matched pages...',
  'knowledge.status.previewMatched': 'Matched {count} page(s).',
  'knowledge.status.previewFailed': 'Preview failed.',
  'knowledge.menu.manage': 'Manage Knowledge Sources',
  'knowledge.menu.add': 'Add Knowledge Source',
  'knowledge.menu.sync': 'Sync Knowledge Sources',
